defmodule ControlPlane.DataCase do
  @moduledoc """
  ...
  by setting `use ControlPlane.DataCase, async: true`, although
  ...
  def setup_sandbox(tags) do
    pid = Sandbox.start_owner!(ControlPlane.Repo, shared: not tags[:async])
